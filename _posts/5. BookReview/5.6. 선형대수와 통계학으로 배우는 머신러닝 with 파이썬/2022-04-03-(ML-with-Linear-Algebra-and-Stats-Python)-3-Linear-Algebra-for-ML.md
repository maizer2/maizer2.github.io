---
layout: post
categories: [5. BookReview, 5.6. 선형대수와 통계학으로 배우는 머신러닝 with 파이썬]
title: "(선형대수와 통계학으로 배우는 머신러닝 with 파이썬) 3. 머신러닝을 위한 선형대수"
tags: [1.1.1. Machine Learning, 1.1. Artificial Intelligence, 2.1.2. Linear Algebra, 2.1. Pure Mathematics, 5.6. 선형대수와 통계학으로 배우는 머신러닝 with 파이썬]
---

## [←  이전 글로](https://maizer2.github.io/5.%20bookreview/2022/00/00/(선형대수와-통계학으로-배우는-머신러닝-with-파이썬)-2.-머신러닝-개요.html) 　 [다음 글로 →](https://maizer2.github.io/5.%20bookreview/2022/04/10/(ML-with-Linear-Algebra-and-Stats-Python)-4-Statistics-for-ML-1.html)
<br/>
