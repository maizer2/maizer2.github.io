...
tags: [1.1.1. Machine Learning, 1.1. Artificial Intelligence, 2.2.2. Statistics, 5.6. 선형대수와 통계학으로 배우는 머신러닝 with 파이썬]
---

## [←  이전 글로](https://maizer2.github.io/5.%20bookreview/2022/04/03/(ML-with-Linear-Algebra-and-Stats-Python)-3-Linear-Algebra-for-ML.html) 　 [다음 글로 →](https://maizer2.github.io/5.%20bookreview/2022/04/12/(ML-with-Linear-Algebra-and-Stats-Python)-4-Statistics-for-ML-2.html)
<br/>
