---
layout: post
categories: [5. BookReview, 5.2. OpenCV 4로 배우는 컴퓨터 비전과 머신 러닝]
title: "(OpenCV 4로 배우는 컴퓨터 비전과 머신 러닝)1. Setting"
tags: [1.1.3.3. OpenCV, 1.1.3. Frameworks, 1.1. Artificial Intelligence, 1.2.2. C++, 1.2. Programming, 5.2. OpenCV 4로 배우는 컴퓨터 비전과 머신 러닝]
---

## [←  이전 글로](https://maizer2.github.io/5.%20bookreview/2021/09/26/(OpenCV-4-CV-and-ML)-0-Introduction.html) 　 [다음 글로 →](https://maizer2.github.io/5.%20bookreview/2021/09/28/(OpenCV-4로-배우는-컴퓨터-비전과-머신-러닝)-2-Lenna-출력하기.html)
