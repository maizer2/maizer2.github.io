---
layout: post
categories: [5. BookReview, 5.9. 미술관에 GAN 딥러닝 실전 프로젝트]
title: "(미술관에-GAN-딥러닝-실전-프로젝트) 1. 생성 딥러닝을 소개합니다-1"
tags: [1.1.2.1. Computer Vision, 5.9. 미술관에 GAN 딥러닝 실전 프로젝트]
---

## [←  이전 글로](https://maizer2.github.io/5.%20bookreview/2022/05/01/(GAN-Art-Gallery-Project)-0-Introduction.html) 　 [다음 글로 →](https://maizer2.github.io/5.%20bookreview/2022/05/00/(미술관에-GAN-딥러닝-실전-프로젝트)-1.-생성-딥러닝을-소개합니다-2.html)
...
이런 과정을 [지도 학습<sup>Supervised Learning</sup>](https://maizer2.github.io/2022/01/24/%EC%A7%80%EB%8F%84-%ED%95%99%EC%8A%B5.html)이라고 부른다.

생성 모델은 Label이 없는 Training Data에서 수행되기에, [비지도 학습<sup>Unsupervised Learning</sup>](https://maizer2.github.io/2022/02/01/%EB%B9%84%EC%A7%80%EB%8F%84-%ED%95%99%EC%8A%B5.html)이라고 부른다. 
