...
[...](https://maizer2.github.io/2022/02/14/Python-Glossary-Translation.html#footnote_2_2) 사용 법과 같지만 Ellipsis는 사용자 정의 컨테이너<sup>다차원 배열</sup>를 기존의 배열을 [:] 사용과 같이 슬라이싱 하는 용도이다.<sup><a href="#footnote_2_1" name="footnote_2_2">[2]</a></sup>
