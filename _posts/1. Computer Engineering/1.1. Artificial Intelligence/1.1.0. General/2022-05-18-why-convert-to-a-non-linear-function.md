...
이 Non-Linear Graph의 최소값을 찾아가기 위해 고안된 Algorithm이 바로 [Gradient Descent Algorithm](https://maizer2.github.io/2022/05/18/Gradient-Descent-Algorithm.html)이다.
...
Non-Linear Function의 최소값을 찾는 과정인 [Gradient Descent Algorithm](https://maizer2.github.io/2022/05/18/Gradient-Descent-Algorithm.html)을 사용하면 Function의 최소지점으로 도달할 수 있게된다.
