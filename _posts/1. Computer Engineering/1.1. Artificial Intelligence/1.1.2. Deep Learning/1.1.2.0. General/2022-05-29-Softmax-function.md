...
tags: [1.1.2. Deep Learning, 1.1. Artificial Intelligence, 2.2.2. Statistics]
---
...
softmax 함수는 결국 [Sigmoid Function](https://maizer2.github.io/2022/05/19/sigmoid-function.html)의 기초 개념으로 만들어진 함수이다.
...
[Sigmoid Cross-Entropy](https://maizer2.github.io/2022/05/15/Binary-Cross-Entropy-Sigmoid-Cross-Entropy.html) 에서 발생했던 $e^{-x}$ 의 $x$값이 너무 낮은 값을 가질 경우 값이 폭주해버리는 문제와 동일하게 위 식의 $e^{x_{i}}$값이 매우 커져 값이 폭주하는 문제, 너무 작아져 분모 분자가 0에 수렴하여 0으로 나눠지는 오류가 발생하게 된다.
