...
[Softmax Function](http://maizer2.github.io/2022/05/29/Softmax-function.html)의 결과값을 [Cross-Entropy](https://maizer2.github.io/2022/05/15/Cross-Entropy.html)의 확률값을 Q로 지정하게 될 때 문제가 발생한다.
