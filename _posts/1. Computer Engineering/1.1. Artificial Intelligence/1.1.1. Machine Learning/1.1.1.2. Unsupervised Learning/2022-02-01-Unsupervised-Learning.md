...
[지도 학습](https://maizer2.github.io/2022/01/24/Supervised-Learning.html) 과는 달리 입력값에 대한 목표치가 주어지지 않는다.
...
* 군집
  ...
  * DBVSCAN
  * 계층 군집 분석
  * [이상치 탐지](https://maizer2.github.io/2022/02/01/이상치-탐지-학습.html) 와 특이치 탐지
  * 원-클래스
  * 아이솔레이션 포레스트
* 시각화와 차원 축소
  * 주성분 분석
