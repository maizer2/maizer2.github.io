...
이는 l = k - 1일 때 [k-l 겹 교차 검증](https://maizer2.github.io/2022/02/06/k-l-Fold-Cross-Validation.html) 의 한 유형이다.
...
[k-l겹 교차 검증](https://maizer2.github.io/2022/02/06/k-l-Fold-Cross-Validation.html) 과 유사하게 훈련 세트는 모델 피팅에 사용되고 검증 세트는 각 하이퍼파라미터 세트에 대한 모델 평가에 사용된다.
