...
* [k-최근접 이웃](https://maizer2.github.io/2022/01/24/k-Nearest-Neighbors-Algorithm.html), k-nearest neighbors
* [선형 회귀](https://maizer2.github.io/2022/01/15/Linear-Regression-Algorithm.html), linear regression
* [로지스틱 회귀](https://maizer2.github.io/2022/05/15/What-is-Logistic.html), logistic regression
* [서포트 벡터 머신](https://maizer2.github.io/2022/01/24/서포트-벡터-머신-알고리즘.html), support vector machine(SVM)
* [결정 트리](https://maizer2.github.io/2022/01/24/결정-트리-알고리즘.html), decision tree
* [랜덤 포레스트](https://maizer2.github.io/2022/01/24/랜덤-포레스트-알고리즘.html), random forest
* [신경망](https://maizer2.github.io/2022/01/24/신경망-알고리즘.html), neural networks
