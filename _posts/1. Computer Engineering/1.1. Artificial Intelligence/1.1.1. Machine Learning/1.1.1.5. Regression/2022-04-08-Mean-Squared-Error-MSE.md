...
[Perceptron](https://maizer2.github.io/2022/05/18/perseptron.html)을 사용했을 때 Linear한 값을 Non-Linear하게 변환해주는 함수로 쓰인다.

$ W\cdot x + b $ 는 1차 함수로서 선형임을 확인할 수 있다.

하지만 MSE Function에 변수 값으로 넣어주게 되면 2차 함수가 되기 때문에 Non-Linear Function이 되게 된다.

왜 Non-Linear transfer 해야하는지는 여기를 참고하자 $\to$ [Why convert to a non-linear function?](https://maizer2.github.io/2022/05/18/why-convert-to-a-non-linear-function.html)