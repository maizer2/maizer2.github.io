---
layout: post
categories: [1. Computer Engineering, 1.1. Artificial Intelligence, 1.1.3. Frameworks, 1.1.3.3. OpenCV]
title: "(OpenCV by Python)2. Lenna 출력하기"
tags: [1.1.3.3. OpenCV, 1.1.3. Frameworks, 1.1. Artificial Intelligence, 1.2.1. Python, 1.2. Programming]
---

## [←  이전 글로](https://maizer2.github.io/1.%20computer%20engineering/2021/10/20/(OpenCV-by-Python)-1-Setup.html) 　 [다음 글로 →](https://maizer2.github.io/1.%20computer%20engineering/2021/10/24/(OpenCV-by-Python)-3-Display-Video.html)
